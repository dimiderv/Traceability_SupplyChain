...
echo "$(json_ccp1 $ORG $P0PORT1 $CAPORT $PEERPEM1 $CAPEM)" > organizations/peerOrganizations/org1.example.com/connection-peer1org1.json
echo "$(yaml_ccp1 $ORG $P0PORT1 $CAPORT $PEERPEM1 $CAPEM)" > organizations/peerOrganizations/org1.example.com/connection-peer1org1.yaml
...
echo "$(json_ccp1 $ORG $P0PORT1 $CAPORT $PEERPEM1 $CAPEM)" > organizations/peerOrganizations/org2.example.com/connection-peer1org2.json
echo "$(yaml_ccp1 $ORG $P0PORT1 $CAPORT $PEERPEM1 $CAPEM)" > organizations/peerOrganizations/org2.example.com/connection-peer1org2.yaml
